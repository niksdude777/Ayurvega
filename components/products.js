...
import img from "../assets/img/divyaMedoharVati.png"
import img1 from "../assets/img/Patanjali-coroniljpg.jpeg"
import img2 from "../assets/img/shankhpowder.jpg"
import img3 from "../assets/img/giloy.jpg"


export default function products(){

    const products1= [
        {id: "nextjs_halfmoon", name: "MEDOHAR VATI 50 GM", price: 80.00, image: img, description: "Divya Medohar Vati is a wonder drug that helps you reduce weight without losing strength and virility.Useful in obesity and hyperlipidemia Controls weight gain Reduces joint pain"},
        {id: "nextjs_dragonscale", name: "Coronil", price: 450.00, image: img1,description: "Immunity booster which comes with 3 different medicines which helps body to fight diseses such as common cold , Respiratory infections"}, 
